! function(e, t) {
    ...
    window.ElementsKit_Helper = {}, ElementsKit_Helper.setURLHash = function(t, n, i) {
        ...
        i.length && !t.hasClass("ekit-ajax-loading") && e.ajax({
            ...
            beforeSend: function() {
                t.addClass("ekit-ajax-loading"), n.toggleClass("icon icon-down-arrow1 eicon-loading eicon-animation-spin"), e(document).width() <= Number(s) ? n.css({
                    border: "none"
                }) : n.css({
                    "padding-right": 0,
                    "margin-right": "5px"
            ...
            success: function(s) {
                t.removeClass("ekit-ajax-loading"), i.replaceWith(s), n.toggleClass("eicon-loading eicon-animation-spin icon icon-down-arrow1").removeAttr("style"), t.find(".elementor-element").each((function() {
